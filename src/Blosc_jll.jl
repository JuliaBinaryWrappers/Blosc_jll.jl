...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Blosc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0b7ba130-8d10-5ba8-a3d6-c5182647fed9"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Blosc", artifacts_toml) for e in artifacts["Blosc"]]
...
if best_platform === nothing
    @debug("Unable to load Blosc; unsupported platform $(triplet(platform_key_abi()))")
else
